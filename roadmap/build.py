...
ten walkable worlds exist. Seven are BUILT: real campuses, each with the
...
the subset of that stack a hub actually needs (see below). Three are
CANDIDATES: real US metros with real trade profiles, proposed as the
next three, and nothing more than proposed.

TWO PROVENANCE TIERS, NOT ONE. Three of the seven built campuses'
...
Chicago, Seattle and Pittsburgh, the fourth through seventh, and the
three remaining candidates' city coordinates are AUTHORED:
...
in full, not just relabelling an entry - Houston, Chicago, Seattle and
Pittsburgh all did it as a HUB campus rather than a district campus (see
HUB_DESIGN below); a future candidate could still go either way.
...
Houston, Chicago, Seattle or Pittsburgh. Instead each hosts no home
district of its own (districts: []) and the chapters mechanic every
campus already had - a regional chapter, for every hall, at every
campus that is not its home - simply gained a fourth, fifth, sixth and
seventh destination: Houston, Chicago, Seattle and Pittsburgh are each
now a regional-chapter seat for all 111 halls, real walkable points on
the network map, and duplicate no hall's content anywhere. None draws a
...
HONESTY = {
    'target_not_claim': 'ten walkable worlds is a target this registry '
                        ...
                        'exist. Seven are built; three are candidates.',
    'provenance_tiers': 'three of the seven built campuses\' coordinates '
                        'are RECORDED - copied from a cited file and '
                        'cross-checked against it on every build. '
                        'Houston, Chicago, Seattle and Pittsburgh, the '
                        'fourth through seventh, and the three remaining '
                        'candidates\' coordinates are AUTHORED: '
    ...
    'hub_vs_district': 'three built campuses are district campuses: a '
                       ...
                       'Chicago, Seattle and Pittsburgh are hub campuses: '
                       'no home district, no district ring, no '
                       ...
                       'fourth, fifth, sixth and seventh destination. '
                       'Building one shape does not oblige the next '
                       'candidate to be the other.',
