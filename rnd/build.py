...
HONESTY = {
    ...
    'predictions_are_not_measurements': 'the whole-campus and whole-hall '
                                        ...
                                        'rules would cost. Nothing either '
                                        'pack declares has been drawn, so no '
                                        'browser has ever confirmed one of '
                                        'them. The budget block spends them '
                                        'against a measured baseline anyway, '
