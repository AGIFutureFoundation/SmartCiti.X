...
| **Simulators** (inside the 3D environment) | 7 operable machines — schematic physics, deterministic rubrics, bound to real skills in 21 halls | [Simulators](Simulators.md) |
