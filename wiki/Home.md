...
| **Simulators** (inside the 3D environment) | 3 operable machines — schematic physics, deterministic rubrics, bound to real skills in 11 halls | [Simulators](Simulators.md) |
