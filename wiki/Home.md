...
| **The world** (sky, weather, ground, animals) | 6 weather states over per-campus atmospheres, 10 generated ground surfaces and 101 animals — and not one texture file anywhere | [World](World.md) |
| **The signs** (every word in the 3D world) | 14 kinds over 10 shapes — shape carries the category, colour the provenance, type the rank, and every sign reacts to where you are looking | [Signs](Signs.md) |
