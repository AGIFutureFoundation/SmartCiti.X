...
| **Simulators** (inside the 3D environment) | 9 operable seats — schematic physics, deterministic rubrics, pre-shift walkarounds, bound to real skills in 41 halls — each with a scripted reference operator at 3 levels (no model, no network) | [Simulators](Simulators.md) |
