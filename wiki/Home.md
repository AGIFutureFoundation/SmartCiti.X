...
| **Simulators** (inside the 3D environment) | 4 operable machines — schematic physics, deterministic rubrics, bound to real skills in 16 halls | [Simulators](Simulators.md) |
