...
**Declared-and-unbuilt is now 5 entries, down from
6**, and the lessons registry is the entry that left.
...
The 5 registries still on that list are still on it, and this page
