...
| Nine-campus network — three district campuses (Treasure Island–SF, Oakland, New Orleans) plus six regional-chapter **hub** campuses with no home district of their own (Houston, Chicago, Seattle, Pittsburgh, Denver, Miami) — real or AUTHORED WGS84 anchors, recomputed great-circle distances for all thirty-six campus pairs, Mapbox-ready GeoJSON | `unions/`, `geo/` |
...
| Generated sky, six weather states, browser-generated ground recipes (zero third-party texture files) and 94 ambient animals across all nine campuses | `world/` |
...
| The 10-world network-roadmap tracker itself: 9 built campuses + 1 candidate metro (Detroit), each candidate carrying the actual checklist to become built | `roadmap/` |
