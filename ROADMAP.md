...
| Six-campus network — three district campuses (Treasure Island–SF, Oakland, New Orleans) plus three regional-chapter **hub** campuses with no home district of their own (Houston, Chicago, Seattle) — real or AUTHORED WGS84 anchors, recomputed great-circle distances for all fifteen campus pairs, Mapbox-ready GeoJSON | `unions/`, `geo/` |
...
| Generated sky, six weather states, browser-generated ground recipes (zero third-party texture files) and 70 ambient animals across all six campuses | `world/` |
...
| The 10-world network-roadmap tracker itself: 6 built campuses + 4 candidate metros (Pittsburgh, Denver, Miami, Detroit), each candidate carrying the actual checklist to become built | `roadmap/` |
