...
**690 checks, all passing from inside this bundle**, with no model credentials
required.
...
node roadmap/test.mjs              # 30 — the network roadmap: 5 built (3 district campuses + 2 regional-chapter hubs) + 5 candidates (AUTHORED) totalling exactly 10, now placed by real bearing/distance on the 3D region board itself
