...
**453 checks, all passing from inside this bundle**, with no model credentials
required.
...
node meta/test.mjs                 # 18 — the metaverse layer: standards, the Unity avatar review, rig vocabulary, import policy, honesty
