...
**658 checks, all passing from inside this bundle**, with no model credentials
required.
...
node training/test.mjs             # 21 — the robotic training-data recorder: episode shapes, the storage/export contract, the not-scored guarantee
