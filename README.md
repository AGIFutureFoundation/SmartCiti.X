...
**727 checks, all passing from inside this bundle**, with no model credentials
required.
...
node restoration/test.mjs          # 27 — the Bay Restoration pack: 9 real, independently-run sfbayrestore.org sites (8 mapped) and 3 field-skill tracks bound to real skill_ids, on the geomap, on the network dashboard, and in a live 3D panel with a bidirectional hall link, not affiliated with or certified by this bundle
