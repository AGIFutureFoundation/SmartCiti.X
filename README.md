...
**397 checks, all passing from inside this bundle**, with no model credentials
required.
...
node avatars/test.mjs              # 24 — locker depth, crews, characters, costumes, the TradeApes, marks policy, the guarantee
