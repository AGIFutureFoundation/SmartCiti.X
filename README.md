...
**416 checks, all passing from inside this bundle**, with no model credentials
required.
...
node sims/test.mjs                 # 21 — simulator bindings, rubrics, cockpit + scoring + regional scenarios
