...
**723 checks, all passing from inside this bundle**, with no model credentials
required.
...
node restoration/test.mjs          # 23 — the Bay Restoration pack: 9 real, independently-run sfbayrestore.org sites (8 mapped) and 3 field-skill tracks bound to real skill_ids, on the geomap and in a live 3D panel, not affiliated with or certified by this bundle
