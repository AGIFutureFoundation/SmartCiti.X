...
**684 checks, all passing from inside this bundle**, with no model credentials
required.
...
node schools/test.mjs              # 19 — flipped-classroom model, proposed districts, live units + class drills, in-app Schools panel
