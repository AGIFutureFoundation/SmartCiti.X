...
**673 checks, all passing from inside this bundle**, with no model credentials
required.
...
node orbis/test.mjs                # 61 — the Orbis synthetic-training prompt contract + the two real video-model runners: no key shipped, no network reached, AI-SYNTHESIZED labelled
