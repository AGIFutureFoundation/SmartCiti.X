...
**632 checks, all passing from inside this bundle**, with no model credentials
required.
...
node orbis/test.mjs                # 35 — the Orbis synthetic-training prompt contract + the real Helios runner: no key shipped, no network reached, AI-SYNTHESIZED labelled
